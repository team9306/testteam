	...
	<table align="center" width="100%" bgcolor="#FCF8CB" border="0">
		...
		<tr height="40">
			<td colspan="5" height="30" align="right"><a
				href="/jquery-validateLogin/index.jsp">首页</a>&nbsp;&nbsp; &nbsp;</td>
		</tr>
		<tr height="40">
			...
			<td>
				<form name="formregister"
					...
					<table border="0" width="800" align="center">
						...
						<tr>
							<!-- <td colspan="2" align="right" height="65"><input
								type="button" id="send" value="提交" /></td>
							<td height="65"><input type="button" id="res" value="重置"></td> -->
